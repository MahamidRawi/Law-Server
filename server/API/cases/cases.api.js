...
const { issueSubpoena } = require('../../actions/main/cases/subpoena.actions');
...
router.get('/getSubpoenasPricings', validate, (req, res) => res.json({ success: true, calculatedPrices }));
